<%@ Page Title="" Language="C#" MasterPageFile="~/GasBooking.Master" AutoEventWireup="true" CodeBehind="deliveredbookings.aspx.cs" Inherits="GasBooking.deliveredbookings" %>
        ...
        <div class="container">
            <div class="panel panel-default">
                <div class="panel-heading panel-heading-custom clearfix" style="color: #fff; background-color: #2892b1;">
                    ...
                    <a href="deliveredbookings.aspx" class="btn btn-info" style="background-color:#2892b1">Delivered Bookings</a>
                ...
                <div class="panel-body" style="padding-top: 30px">
                     <div class="col-md-12" style="overflow-x:auto;">
                         <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" Caption="Delivered Bookings" CellPadding="4" CssClass="table" DataKeyNames="booking_id" DataSourceID="SqlDataSource1" EmptyDataText="Records not Found" ForeColor="#333333" GridLines="None" ShowFooter="True" ShowHeaderWhenEmpty="True">
                         ...
                         <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [booking_id], [aadhaar_no], [last_name], [middle_name], [first_name], [address], [city], [state], [phone_no], [cylinder_type], [collection_mode], [price], [booking_date], [booking_status], [delivery_date] FROM [booking] WHERE ([booking_status] = @booking_status) ORDER BY [delivery_date] DESC">
                             <SelectParameters>
                                 <asp:Parameter DefaultValue="delivered" Name="booking_status" Type="String" />
                             </SelectParameters>
                         </asp:SqlDataSource>
                     </div>
                </div>
