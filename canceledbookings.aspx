<%@ Page Title="" Language="C#" MasterPageFile="~/GasBooking.Master" AutoEventWireup="true" CodeBehind="canceledbookings.aspx.cs" Inherits="GasBooking.canceledbookings" %>
        ...
        <div class="container">
            <div class="panel panel-default">
                <div class="panel-heading panel-heading-custom clearfix" style="color: #fff; background-color: #2892b1;">
                    ...
                    <a href="canceledbookings.aspx" class="btn btn-info" style="background-color:#2892b1">Canceled Bookings</a>
                ...
                <div class="panel-body" style="padding-top: 30px">
                     <div class="col-md-12" style="overflow-x:auto;">
                         <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" BorderColor="White" Caption="Canceled Bookings" CellPadding="4" CssClass="table table-bordered" DataKeyNames="booking_id" DataSourceID="SqlDataSource1" EmptyDataText="No Canceled Bookings" ForeColor="#333333" GridLines="None" ShowFooter="True" ShowHeaderWhenEmpty="True">
                             ...
                             <Columns>
                                 ...
                                 <asp:BoundField DataField="cancel_date" HeaderText="Cancel Date" SortExpression="cancel_date" />
                             </Columns>
                         ...
                         <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [booking_id], [aadhaar_no], [first_name], [middle_name], [last_name], [address], [city], [state], [phone_no], [cylinder_type], [collection_mode], [price], [booking_date], [booking_status], [cancel_date] FROM [booking] WHERE ([booking_status] = @booking_status) ORDER BY [cancel_date] DESC">
                             <SelectParameters>
                                 <asp:Parameter DefaultValue="canceled" Name="booking_status" Type="String" />
                             </SelectParameters>
                         </asp:SqlDataSource>
                     </div>
                </div>
